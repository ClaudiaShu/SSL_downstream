...
from data_aug import get_image_transform, get_audio_transform, get_cv_image_transform
from data_loader import AFFECTNET_Dataset, Aff2_Dataset_static_shuffle, Aff2_Dataset_audio, AFFECTNET_hdf5
...
from models.model_DenseNet import Dense_feature
...
parser.add_argument('--model_dir', default="/mnt/c/Data/Yuxuan/data/SSL_model/simclr_with_time_neg_img_c/checkpoint_best.pth.tar")
...
def setup_AffectNet(args):
    train_transform, valid_transform = get_cv_image_transform()
    # train set
    ...
    #                                   root=False,
    #                                   transform=train_transform)
    train_data = "/mnt/c/Data/Yuxuan/AffectNet/AffectNet_train.hdf5"
    valid_data = "/mnt/c/Data/Yuxuan/AffectNet/AffectNet_valid.hdf5"

    train_dataset = AFFECTNET_hdf5(train_data, transform=train_transform)
    valid_dataset = AFFECTNET_hdf5(valid_data, transform=valid_transform)
