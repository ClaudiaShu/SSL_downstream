...
from ABAW_v import ABAW_trainer
from data_aug import get_image_transform, get_video_transform
from data_loader import Aff2_Dataset_series_shuffle, Aff2_Dataset_static_shuffle
from models.model_DFEW import BaselineRNN
from models.model_R3D_DFEW import DFEW_SSL
from models.model_R3D_imagenet import RES3D_feature
...
parser.add_argument('--arch', default='MC3', type=str, help='baseline of the training network.')
...
def setup(df_train, df_valid, args):
    train_transform, test_transform = get_video_transform(args.seq_len)
...
def main():
    ...
    if args.rep == 'pretrain':
        model = RES3D_feature(module=args.arch)
    elif args.rep == 'SSL':
        model = DFEW_SSL()
    else:
        model = BaselineRNN()
